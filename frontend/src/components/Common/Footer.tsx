        ...
        <div className="pl-6">
            ...
            <form className="flex">
                ...
                placeholder="Enter your email"
                 className="p-3 w-full text-s, border-t border-l border b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all"  required />
