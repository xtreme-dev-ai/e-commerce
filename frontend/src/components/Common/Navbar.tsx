    ...
    return (
        <>
            <nav className="container mx-auto flex items-center justify-between py-4 px-6">
                <div>
                    <a href="/" className="text-2xl font-medium">Rabbit</a>
                </div>

                <div className="hidden md:flex space-x-6">
                    <a href="#" className="text-gray-700 hover:text-black text-sm font-medium uppercase">Men</a>
                    <a href="#" className="text-gray-700 hover:text-black text-sm font-medium uppercase">Women</a>
                    <a href="#" className="text-gray-700 hover:text-black text-sm font-medium uppercase">Top Wear</a>
                    <a href="#" className="text-gray-700 hover:text-black text-sm font-medium uppercase">Bottom Wear</a>
                </div>
